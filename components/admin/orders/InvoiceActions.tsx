...
export default function InvoiceActions({ orderId }: Props) {
  return (
    <div className="rounded-3xl border border-zinc-800 bg-zinc-900/40 p-8">
      ...
      <div className="mt-6 rounded-2xl border border-zinc-800 bg-zinc-950/60 p-6 transition-all duration-300 hover:border-violet-500/50 hover:bg-zinc-900">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="font-semibold text-white">Customer Invoice</h3>
        ...
        <div className="mt-6 grid gap-3">
          ...
          <a
            href={`/api/orders/${orderId}/invoice?download=1`}
